...
function updateMarker(root, { data, style, theme }) {
    ...
    const markers = data
        ...
        const shape = new Circle({
            style: Object.assign({ cx: point[0], cy: point[1], fill, r: 4, stroke: '#fff', lineWidth: 2 }, style),
        });
        return shape;
    });
